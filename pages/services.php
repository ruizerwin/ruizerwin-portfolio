        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-item item-teal">
                    ...
                    <p>
                        Create responsive interfaces using Bootstrap, JavaScript, and modern front-end practices connected to solid backend systems.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="service-item item-indigo">
                    ...
                    <h3>Web Security</h3>
                    <p>
                        Apply secure coding practices such as input validation, output escaping, session protection, and general system hardening.
                    </p>
                </div>
            </div>
